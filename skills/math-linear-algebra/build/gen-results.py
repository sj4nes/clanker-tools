...
for mod in ("spec_roots", "spec_vector_spaces", "spec_linear_maps",
            "spec_matrices", "spec_determinants", "spec_eigentheory",
            "spec_inner_product", "spec_spectral", "spec_boundary"):
    try:
        __import__(mod)
