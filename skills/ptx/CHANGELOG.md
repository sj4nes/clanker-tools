...
**MINOR.** `-W '[A-Za-z0-9_]+'` for whole-identifier indexing and `ptx -A` for
`file:line:` provenance added post-release. Additions; the existing caveat was
confirmed correct, not corrected. Recorded in the version re-base (`0fbb03c`,
