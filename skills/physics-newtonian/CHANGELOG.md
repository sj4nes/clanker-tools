...
history rather than every change. The full record is
    ...
    git log -- skills/physics-newtonian/

## 2.1.0 — 2026-09-14

**MINOR.** One formula entry had no `Prereqs:` line at all. The graph was
right, so a prerequisite query answered correctly; the human-facing entry
merely omitted the list. (`904ea6a`)
