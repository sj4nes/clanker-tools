# Changelog — unattended-automation
...
history rather than every change. The full record is
    ...
    git log -- skills/unattended-automation/

## 1.1.0 — 2026-09-13

**MINOR.** One recorded post-release revision (the Procedural-Graphs fold-in),
preserved as a minor. Recorded in the version re-base (`0fbb03c`, adjudicated
