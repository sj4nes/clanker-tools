...
| `conventions.md` | **done** |
| node registry `nodes/nodes.tsv` | **112 nodes**, all `draft` |
| prerequisite graph | **271 edges, acyclic** (`tsort` clean, BSD-safe check), 0 isolated nodes; `edges/cycles.md`, `edges/relations.tsv` done |
