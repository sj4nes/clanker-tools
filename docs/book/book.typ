...
//
// Builds Parts I, II (II.1 only) and III. Parts I and II are agent DRAFTS (2026-09-16) pending the
...
#part("II", "The Standard")[
  ...
  #v(0.8em)
  #note[Draft, 2026-09-16: agent-written from the fat outline and the II.1
  rows of `claim-ledger.md`, to be rewritten in the author's voice. Only
  chapter II.1 is drafted.]
]
