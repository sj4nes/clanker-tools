...
## Status: Parts I (draft), II.1 (draft) and III
...
| II — The standard (verification bar, displacement tables, versioning) | authored | no | **II.1 draft** (2026-09-16, agent-written; ledger C-II-05..13) |
